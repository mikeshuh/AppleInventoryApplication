...
public class MacbookSearchController implements Initializable {
    ...
    /** ObservableList<String> modelChoiceList = FXCollections.observableArrayList("Base", "Pro", "Air");
    ObservableList<String> colorChoiceList = FXCollections.observableArrayList("Space Gray", "Gold", "Silver", "Midnight", "Starlight", "Space Black");
    ObservableList<String> sizeChoiceList = FXCollections.observableArrayList("13-inch", "14-inch", "15-inch", "16-inch");
    ObservableList<String> chipChoiceList = FXCollections.observableArrayList("M1", "M2", "M3", "M3 Pro", "M3 Max"); */
